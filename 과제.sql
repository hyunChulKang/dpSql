...
CREATE TABLE locations ( 
		...
		ALTER TABLE locations ADD CONSTRAINT fk_cnt_id FOREIGN KEY (country_id) REFERENCES countries (country_id);
...
CREATE TABLE departments ( 
        ...
        ALTER TABLE departments ADD CONSTRAINT fk_loc_id FOREIGN KEY (location_id) REFERENCES locations (location_id);
...
CREATE TABLE job_history (
        ...
        job_id VARCHAR2(10),
        department_id NUMBER(4),
        CONSTRAINT pk_start_date PRIMARY KEY (start_date,employee_id)
);
        ALTER TABLE job_history ADD CONSTRAINT fk_job_id FOREIGN KEY (job_id) REFERENCES jobs (job_id);
        ALTER TABLE job_history ADD CONSTRAINT fk_deptment_id FOREIGN KEY (department_id) REFERENCES departments(department_id);
CREATE TABLE employees  (
        ...
        ALTER TABLE employees ADD CONSTRAINT fk_mgrager_id FOREIGN KEY (manager_id) REFERENCES employees (employee_id);
